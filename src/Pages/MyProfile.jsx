            ...
            <p>
              <input
                ...
                onChange={(e) =>
                  setUserData((prevData) => ({
                    ...prevData,
                    address: { ...prevData.address, line1: e.target.value },
                  }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setUserData((prevData) => ({
                    ...prevData,
                    address: { ...prevData.address, line2: e.target.value },
                  }))
                }
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          ...
          {isEdit ? (
            ...
            <p className="text-gray-400 cursor-pointer">{userData.dob}</p>
          )}
        </div>
      </div>
